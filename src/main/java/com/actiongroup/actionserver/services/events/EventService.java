...
public class EventService {
    ...
    public void deleteEvent(Event event) {
        var stat = statisticsRepository.findByEvent(event);
        if (stat != null)
            deleteStatistics(stat);
        eventPathService.deleteCheckpointsByEvent(event);
    ...
    public List<Event> getEventsByArchive(Archive archive) {
        return eventRepository.findByArchive(archive);
    }
}
